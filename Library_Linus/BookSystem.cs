...
namespace Libary
{
    ...
    class BookSystem
    {
        ...
        private static string booksFile = @"C:\Users\linus.andersson23\Desktop\Prog2\C#\Library_Linus\books.json";
        ...
        void LoadBooks()
        {
            string data = File.ReadAllText(@"C:\Users\linus.andersson23\Desktop\Prog2\C#\Library_Linus\books.json");
