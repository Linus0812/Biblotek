...
namespace Libary
{
    class MyBooks
    {
        public static void Show()
        {
            ...
            string data = File.ReadAllText(@"C:\Users\linus.andersson23\Desktop\Prog2\C#\Library_Linus\users.json");
            dynamic usersData = JsonConvert.DeserializeObject<dynamic>(data);
            string data2 = File.ReadAllText(@"C:\Users\linus.andersson23\Desktop\Prog2\C#\Library_Linus\books.json");
            ...
            foreach (var user in usersData)
            {
                if (user.username == Login.username1)
                {
                    ...
                    if (answer1 == "1")
                    {
                        ...
                        File.WriteAllText(@"C:\Users\linus.andersson23\Desktop\Prog2\C#\Library_Linus\users.json", dataToSave);
                        string dataToSave2 = JsonConvert.SerializeObject(bookData);
                        File.WriteAllText(@"C:\Users\linus.andersson23\Desktop\Prog2\C#\Library_Linus\books.json", dataToSave2);
